...
import com.maran.workshop.services.ProductService;
...
public class ProductResource {
    ...
    public ResponseEntity<Product> findById(@PathVariable Long id){ //To make Spring consider the parameter that will be received by URL, it is necessary to use @PathVariable
